...
public class SortingManager {
	...
	public static void main(String[] args) {
		...
		int[] unsortedForEnd = { 5, 2, 6, 9, 4, 1, 8, 3, 7, -5 }; // { 8, 1, 9, 5 }; // unsortedForBegin; // 
		...
		/* I'm interesting, which is easier to read? (1) or (2) ?
		 * I think, in this case (1) need know language basics
		 * An this case (2) have to hope for «enemy» method realization
		 * That's why I doubt
		 */
